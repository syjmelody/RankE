...
class Transformer(nn.Module):
    ...
    def setup_caches(self, max_batch_size, max_seq_length, dtype):
        # [Fix] If Autocast (BF16/FP16) is enabled, force the cache to use the matching low-precision dtype
        # Otherwise the default float32 cache can trigger an Index put error
