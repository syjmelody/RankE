#!/bin/bash
#SBATCH --job-name=ranke_llamagen_train_clip
...
EXP_PREFIX="ranke_${TRAIN_MODE}_blip3o"      # Experiment name prefix
SCALING_SIZE="15k"             # Dataset scale (5k / 10k / 20k)
...
LAMBDA_DEC_REWARD=0.01         # Direct reward-backprop weight                   ******** key setting ********
